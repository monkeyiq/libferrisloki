...
// $Id: SmartPtr.h,v 1.2 2010/09/18 21:36:23 ben Exp $
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        template <class F>
        friend typename DefaultSPStorage<F>::PointerType GetImplX(const DefaultSPStorage<F>& sp);
    ...
    template <class T>
    inline typename DefaultSPStorage<T>::PointerType GetImplX(const DefaultSPStorage<T>& sp)
    { return sp.pointee_; }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    public:        
        ...
        PointerType getRawPointer() const
        {
            return GetImplX(*this);
        }
    };

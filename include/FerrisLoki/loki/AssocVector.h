...
// $Id: AssocVector.h,v 1.1 2007/12/10 11:58:51 ben Exp $
...
//        using reference = std::allocator_traits<A>::value_type&;
        typedef typename std::allocator_traits<A>::value_type& const_reference;
